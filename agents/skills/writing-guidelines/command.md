...
- Javascript is the default for new code unless the surface is genuinely language-agnostic
...
- **Relevance**: code samples included where applicable (JavaScript first; `<Steps/>` for multi-step flows)
...
- JS examples where JavaScript is the convention
